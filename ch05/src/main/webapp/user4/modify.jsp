		...
		<form action="./proc/modify.jsp" method="post">
			<table border="1">
				...
				<tr>
					...
					<td>
						<label>
							<input type="radio" name="gender" value="M" <%= (user4 != null && "M".equals(user4.getGENDER())) ? "checked" : "" %> /> 남자
						</label>
						<label>
							<input type="radio" name="gender" value="F" <%= (user4 != null && "F".equals(user4.getGENDER())) ? "checked" : "" %> /> 여자
						</label>
					</td>
				</tr>
